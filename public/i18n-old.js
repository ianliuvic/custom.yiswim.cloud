...
(function () {
    ...
    var dict = {
        ...
        // ── Step 1 ──
        "上传自主设计包 (OEM) 开始定制，支持同时上传多款。": "Upload your own design package (OEM) to start customizing. Multiple styles supported.",
        "现有款式 (ODM)": "ODM",
        "自主设计 (OEM)": "OEM",
        ...
        "包含款式数": "Style Count",
        "款": "style(s)",
        "项目/系列简要描述": "Project/Collection Description",
        "项目描述": "Project Description",
        "简要描述您即将上传的款式的整体信息，例如：产品类型、设计风格、目标市场等": "Briefly describe the overall info of styles you are uploading, e.g. product type, design style, target market, etc.",
        ...
        "请上传款式参考图或草图": "Please upload style reference images or sketches",
        ...
        "尺寸信息": "Size Information",
        "请提供尺寸说明或上传尺寸文件": "Please provide size description or upload size files",
        "尺寸文字说明": "Size Description",
        "请描述尺码范围、各部位尺寸要求等...": "Please describe size range, measurement requirements for each part, etc...",
        "尺寸文件上传": "Size File Upload",
        "拖拽或点击上传尺寸文件": "Drag or click to upload size files",
        "尺寸": " size file(s)",
        ...
        "请在上方清单中选择款式以预览费用...": "Select styles in the list above to preview fees...",
        "预估打样费 (USD)": "Estimated Sample Fee (USD)",
        "同款同色大货 >300件 基础打样费全额退还": "Same style & color bulk >300 pcs, basic sample fee fully refunded",
        "部分款式打样数量超过 2 件，超出部分将加收缝制费。": "Some styles exceed 2 samples, extra pieces will incur sewing fees.",
        ...
        "$40/款。使用替代面辅料，仅供检查版型、尺寸及整体效果。": "$40/style. Uses substitute materials, for checking pattern, sizing and overall effect.",
        "正确样 (PP):": "PP Sample:",
        "$50/款。使用正确面辅料，完整还原大货效果。": "$50/style. Uses correct bulk materials, fully replicates production effect.",
        "尺码建议": "Size Recommendation",
        "建议选择 M 码 (US 6-8) 作为打样基准码。": "Recommend M size (US 6-8) as sampling base size.",
        "如果您需要核对放码比例，建议在正确样阶段增加一个最大或最小码。": "If verifying grading, add a max or min size at PP stage.",
        "数量说明": "Quantity Guide",
        "每款默认包含 1 件，可免费加做 1 件（最多 2 件免费）。": "Each style includes 1 piece by default, 1 extra free (max 2 free per style).",
        "超过 2 件的部分，每件加收相应缝制费。": "Beyond 2 pieces, extra sewing fee charged per piece.",

        // ── Fee Standard Modal ──
        "红绣服饰 泳装打样收费标准": "Hongxiu Swimwear Sampling Fee Standard",
        "打样分为初样和正确样两种，费用采用模块化透明计费。": "Sampling includes Proto and PP types, with modular transparent billing.",
        "初样": "Proto Sample",
        "使用替代面辅料，仅供检查版型、尺寸及整体效果": "Uses substitute materials, for checking pattern, sizing and overall effect",
        "正确样": "PP Sample",
        "使用正确面辅料，完整还原大货效果": "Uses correct bulk materials, fully replicates production effect",
        "制版费：": "Pattern Making Fee:",
        "缝制费：": "Sewing Fee:",
        "管理费：": "Management Fee:",
        "其他说明": "Additional Notes",
        "每款打样默认包含 1 件样衣，可额外免费制作 1 件（即每款最多免费 2 件）；超过 2 件的部分，每件加收相应缝制费": "Each style includes 1 sample by default, 1 extra free (max 2 free per style); beyond 2, extra sewing fee charged per piece",
        "如果款式特殊或需要在样衣上进行复杂工艺（如镶钻、印标等），视情况需要额外收费": "Special styles or complex crafts (e.g., rhinestones, printed labels) may incur extra fees",
        "打样费一经收取概不退还": "Sample fees are non-refundable once collected",
        "大货退还计划：": "Bulk Refund Plan:",
        "当同款同色大货数量超过 300 件 时，基础打样费将全额退还！": "When same style same color bulk order exceeds 300 pcs, basic sample fees will be fully refunded!",
        ...
        "装箱与包装需求描述": "Packing Requirement Description",
        ...
        "ODM / OBM + 常规面辅料、颜色/印花": "ODM / OBM + Standard Materials, Colors & Prints",
        "红绣现有成熟版型，搭配市场现货常规面料、常规颜色及通用辅料。极速返单，适合试水测款。": "Hongxiu's existing proven patterns with standard market fabrics, colors and universal trims. Fast reorder, ideal for market testing.",
        ...
        "已加载询盘数据，修改后重新提交": "Inquiry data loaded. Edit and resubmit.",
    ...
    var jsDynamic = {
        ...
        "您的需求编号为:": "Your inquiry number:",
        "专属业务经理将在 24 小时内为您提供正式报价。": "A dedicated account manager will provide a formal quote within 24 hours.",
        "正在压缩图片...": "Compressing images...",
        "正在上传文件...": "Uploading files...",
        "正在压缩并上传文件...": "Compressing and uploading files...",
        "提交失败，请稍后重试。": "Submission failed. Please try again later.",
        "网络异常，请检查网络后重试。": "Network error. Please check your connection and try again.",
        ...
        "标准修长型": "Slim Type",
        "标准矩形": "Standard Rectangle",
        "标准矩形 (约 5x8cm)": "Standard Rectangle (approx. 5x8cm)",
        "约": "approx.",
        "子母牌": "Main & Sub tags",
        "烫金/烫银": "Gold/Silver Foil",
        "局部UV": "Spot UV",
        "无附加工艺": "None",
        "常规方块吊粒": "Standard square loop",
        ...
        "CIF 到岸交货": "CIF",
        "EXW 工厂交货": "EXW",
        "快递账号到付": "Customer account (collect)",
        "国内顺丰": "SF Express",
        "件": "pcs",
        "项": "item(s)",
        "目标": "Target",
        ...
        "快递:": "Courier:",
        "待定": "TBD",
        "已传包装要求图": "Packing files uploaded",
        ...
        "① 款式定义：请至少上传一个 OEM 设计": "① Style: Upload at least one OEM design",
        ...
        // ── User Center: Header & Nav ──
        "返回主页": "Back to Home",
        "返回询盘": "Back to Inquiries",
        "退出": "Log Out",

        // ── User Center: Sidebar ──
        "询盘记录": "Inquiry Records",
        "账户设置": "Account Settings",

        // ── User Center: Inquiry List ──
        "+ 新建询盘": "+ New Inquiry",
        "暂无询盘记录": "No inquiry records yet",
        "加载中...": "Loading...",

        // ── User Center: Draft Banner ──
        "有一份未完成的询盘草稿": "You have an unfinished inquiry draft",
        "继续填写": "Continue Editing",
        "删除草稿": "Delete Draft",
        ...
        "已选款式": "Selected Styles",
        "自主设计": "Custom Design",
        "项目名称": "Project Name",
        "款式数量": "Style Count",
        "款式描述": "Style Descriptions",
        "设计文件": "Design Files",
        "寄送样衣": "Sample Shipping",
        "已寄送实体样衣": "Physical sample shipped",
        "待更新物流单号": "Tracking # pending",
        ...
        "定位印花": "Placement Print",
        "印花图案": "Print Pattern",
        "参考底色": "Reference Base Color",
        "缩放比例": "Scale Ratio",
        "需求描述": "Requirement Description",
        "成分": "Composition",
        "克重": "Weight (GSM)",
        "颜色要求": "Color Requirement",
        "实物邮寄": "Physical Mail",
        "全衬里": "Full Lining",
        "衬里位置": "Lining Placement",
        "拼色说明": "Color Blocking Notes",
        "参考文件": "Reference Files",
        "客户自行提供面料 (CMT)": "Customer-supplied Fabric (CMT)",
        "明细描述": "Detail Description",
        "寄件单号": "Shipping Tracking #",
        ...
        "卫生贴": "Hygiene Sticker",
        "其他": "Other",
        "红绣标配": "Hongxiu Standard",
        "客户自定义": "Customer Customized",
        "表面处理": "Surface Finish",
        "通用参考文件": "General Reference Files",
        "LOGO定制": "Logo Customization",
        "需要": "Required",
        "LOGO类型": "Logo Type",
        "通用LOGO文件": "General Logo Files",
        "样式参考": "Style Reference",
        "独立LOGO": "Dedicated Logo",
        "LOGO文件": "Logo Files",
        "厚度": "Thickness",
        "颜色": "Color",
        "异形": "Custom Shape",
        "形状参考": "Shape Reference",
        "其他参考": "Other Reference",
        "材质": "Material",
        "尺寸": "Size",
        "印刷": "Print",
        "工艺": "Craft",
        ...
        "圆角": "Rounded Corners",
        "形状说明": "Shape Description",
        "刀模/异形参考": "Die-cut / Custom Shape Reference",
        "工艺说明": "Craft Description",
        "工艺参考": "Craft Reference",
        "吊绳": "String",
        "吊绳参考": "String Reference",
        "绳色": "String Color",
        "副牌": "Sub-tag",
        "缝制方式": "Sewing Method",
        "缝制说明": "Sewing Description",
        "缝制方式参考": "Sewing Method Reference",
        "部件": "Components",
        "打标位置参考 (上)": "Label Placement Reference (Top)",
        "打标位置参考 (下)": "Label Placement Reference (Bottom)",
        "主标与洗水标": "Main Label & Care Label",
        "分开定制": "Customized Separately",
        "分开说明": "Separation Description",
        "形状": "Shape",
        "异形刀模参考": "Custom Die-cut Reference",
        "免粘贴": "Non-adhesive",
        "异形要求": "Custom Shape Requirement",
        "粘贴规则": "Adhesive Rules",
        "粘贴位置参考": "Adhesive Position Reference",
        "印刷设计图": "Print Design",
        "参考附件": "Reference Attachments",
        "客户自行提供 (CMT)": "Customer-supplied (CMT)",
        "其他文件": "Other Files",
        ...
        "数量": "Qty",
        "备注": "Remark",
        "样衣物流": "Sample Logistics",
        "物流方式": "Shipping Method",
        "需大货报价": "Need Bulk Quote",
        "预估大货数量": "Estimated Bulk Qty",
        "期望EXW单价": "Target EXW Unit Price",
        "贸易术语": "Trade Terms",
        "运输方式": "Transport Method",
        "样衣目的地": "Sample Destination",
        "大货明细": "Bulk Details",
        "尺码分配": "Size Allocation",
        "大货物流": "Bulk Logistics",
        "大货目的地": "Bulk Destination",
        "目标价格": "Target Price",
        "包装备注": "Packaging Remark",
        "包装参考文件": "Packaging Reference Files",
        "综合工艺单 / 企划书": "Comprehensive Tech Pack / Plan",
        ...
        "回复内容": "Response",
        "项目链接": "Project Link",
        "项目 Token": "Project Token",
        "其他附件": "Other Attachments",
        "时间线": "Timeline",
        "创建询盘": "Inquiry Created",
        "最后更新": "Last Updated",

        // ── User Center: Status Labels ──
        "待处理": "Pending",
        "处理中": "Processing",
        "已报价": "Quoted",
        "已关闭": "Closed",
        ...
        "轻定制详情": "Customization Details",

        // ── User Center: Account Settings ──
        ...
        "新密码至少需要8位": "New password must be at least 8 characters",
        "提交中...": "Submitting...",
        ...
        // ── User Center: Actions ──
        "确定要删除询盘 ": "Are you sure you want to delete inquiry ",
        " 吗？": "?",
        "删除失败：": "Delete failed: ",
        "未知错误": "Unknown error",
        "复制失败：数据过大或存储不可用": "Copy failed: data too large or storage unavailable",
        "获取询盘数据失败：": "Failed to fetch inquiry data: ",
        "草稿不存在或已过期": "Draft does not exist or has expired",
        "获取草稿失败": "Failed to get draft",
        "确定要删除草稿吗？": "Are you sure you want to delete the draft?",
        "删除失败": "Delete failed",
        "网络错误": "Network error"
    };
