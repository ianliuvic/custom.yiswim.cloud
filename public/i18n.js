...
(function () {
    ...
    var dict = {
        ...
        "China": "中国",
        "Upload your own design package (OEM) to start customizing. Multiple styles supported.": "上传自主设计包 (OEM) 开始定制，支持同时上传多款。",
        "Clear": "清空当前选择",
        ...
        "Nude Sponge": "海绵裸色",
        "ODM": "自主设计 (OEM)",
        "ODM / OBM + Standard Materials, Colors & Prints": "OEM + 常规面辅料、颜色/印花",
    ...
    var jsDynamic = {
        ...
        "✓ Uploaded": "✓ 已传稿/内容",
        "✨ Customized": "✨ 已定制",
        "① Style: Upload at least one OEM design": "① 款式定义：请至少上传一个 OEM 设计",
        "1-Color Print": "单色印刷",
