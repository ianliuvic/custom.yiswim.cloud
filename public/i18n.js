...
(function () {
    ...
    var dict = {
        ...
        "至少8位": "Minimum 8 characters",
        "再次输入新密码": "Re-enter new password",
        "保存修改": "Save Changes",
        // Inquiry list
        "暂无询盘记录": "No inquiry records",
        "加载失败：": "Load failed: ",
        "大货": "Bulk",
        "样衣": "Sample",
        // Status labels
        ...
        "需求描述": "Description",
        "成分": "Composition",
        "颜色要求": "Color Requirements",
        "实物邮寄": "Physical Mailing",
        "衬里位置": "Lining Placement",
        "拼色说明": "Color Block Notes",
        "参考文件": "Reference Files",
        "客户自行提供面料 (CMT)": "Customer provides fabric (CMT)",
        "明细描述": "Detail Description",
        "客供面料文件": "Customer Fabric Files",
        ...
        "客户自定义": "Customer Custom",
        "表面处理": "Surface Finish",
        "通用参考文件": "General Ref. Files",
        "LOGO定制": "Logo Custom",
        "需要": "Required",
        "LOGO类型": "Logo Type",
        "通用LOGO文件": "General Logo Files",
        "样式参考": "Style Reference",
        "独立LOGO": "Separate Logo",
        "LOGO文件": "Logo Files",
        "厚度": "Thickness",
        "颜色": "Color",
        "定制色": "Custom color",
        ...
        "绳色": "String Color",
        "副牌": "Sub Tag",
        "材质参考": "Material Reference",
        "缝制方式": "Sewing Method",
        "缝制说明": "Sewing Note",
        "缝制方式参考": "Sewing Reference",
        "部件": "Components",
        "打标位置参考": "Label Position Ref.",
        "主标与洗水标": "Main & Care Label",
        "分开定制": "Separate Customization",
        "分开说明": "Separation Note",
        "异形刀模参考": "Shape Die-cut Ref.",
        "免粘贴": "No Adhesive",
        "异形要求": "Shape Requirements",
        "粘贴规则": "Application Rules",
        "粘贴位置参考": "Position Reference",
        "印刷设计图": "Print Design",
        "参考附件": "Ref. Attachments",
        "其他文件": "Other Files",
        // Shipping section
        "交付模式": "Delivery Mode",
        "样衣明细": "Sample Details",
        ...
        "预估大货数量": "Est. Bulk Quantity",
        "期望EXW单价": "Expected EXW Price",
        "贸易术语": "Trade Terms",
        ...
        "目标价格": "Target Price",
        "包装备注": "Packaging Note",
        "包装参考文件": "Packaging Ref. Files",
        "综合工艺单 / 企划书": "Tech Pack / Planning Doc",
        ...
        "最后更新": "Last Updated",
        // Error / confirm messages (for _t() in JS)
        ...
        "获取询盘数据失败：": "Failed to get inquiry data: ",
        ...
        // Draft messages
        "保存于": "Saved on",
        "草稿不存在或已过期": "Draft not found or expired",
        "获取草稿失败": "Failed to load draft",
        "确定要删除草稿吗？": "Delete this draft?",
        "删除失败": "Delete failed",
        "网络错误": "Network error"
    };
