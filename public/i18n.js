...
(function () {
    ...
    var dict = {
        ...
        "请上传款式参考图或草图 (仅限图片)": "Please upload style reference images or sketches (images only)",
        ...
        "寄件单号 (选填)：": "Tracking Number (Optional):",
        ...
        "寄件快递单号 (选填)...": "Shipping tracking number (optional)...",
        "纯色": "Solid",
        "定制印花": "Custom Print",
        ...
        "拼色说明与参考附件 (可选)": "Color Blocking Notes & Reference Attachments (Optional)",
        ...
        "全衬里 (Full Lining)": "Full Lining",
        "局部衬里 (Partial)": "Partial Lining",
        ...
        "我将自行采购并寄送面辅料 (CMT 模式 / Customer Supplied Material)": "I will purchase and ship fabrics/materials myself (CMT Mode)",
        ...
        "否 (No)": "No",
        "是 (Yes)": "Yes",
        "我将自行采购并寄送该辅料 (CMT 模式)": "I will purchase and send this trim myself (CMT Mode)",
        ...
        "红绣智能代配 (推荐)": "Hongxiu Smart Match (Recommended)",
        ...
        "点击上传品牌 Logo 矢量图 (AI / PDF / 高清 PNG)": "Click to upload brand Logo vector file (AI / PDF / HD PNG)",
        ...
        "我有特殊的定制形状或特定尺寸需求 (需重新开模)": "I have special custom shape or specific size requirements (requires new mold)",
        ...
        "上薄下厚 (Push-up)": "Top Thin Bottom Thick (Push-up)",
        "底部加厚垫高 1.5cm+": "Bottom thickened, raised 1.5cm+",
        "胸垫颜色": "Chest Pad Color",
        "海绵裸色 (Nude)": "Nude Sponge",
        "白色 (White)": "White",
        "黑色 (Black)": "Black",
        ...
        "参考图上传 (选填)": "Reference Image Upload (Optional)",
        ...
        "通用矩形 (Standard)": "Standard Rectangle",
        ...
        "边缘做圆角处理 (Rounded Corners)": "Round corner edge processing",
        ...
        "我需要子母吊牌 (两张及以上一套)": "I need connected hang tags (two or more as a set)",
        ...
        "目标服装部件 (可多选)": "Target Component (Multi-select)",
        "上装 / 连体泳装 (Top / One-Piece)": "Top / One-Piece Swimsuit",
        "下装 / 泳裤 (Bottom / Pants)": "Bottom / Swim Trunks",
        ...
        "位置参考图 (选填)": "Position Reference Image (Optional)",
        ...
        "我需要将品牌主标与洗水成分标分开定制 (Split Labels)": "I need to customize the brand main label and wash care label separately (Split Labels)",
        ...
        "请务必了解您的目标销售国对服装水洗标的强制性法规要求。通常必须包含：原产地 (Made in China)、准确的纤维成分百分比及适用的洗涤护理图标。若因标签缺失必填信息导致海关扣留或市场处罚，工厂无法承担相关责任。": "Please understand your target country's mandatory care label regulations. Must include: Country of Origin, fiber composition percentages, and laundry care icons. The factory cannot be held responsible for customs detention caused by missing label information.",
        ...
        "透明 PET (标准)": "Transparent PET (Standard)",
        ...
        "刀模图/异形参考 (选填)": "Die-cut template / special shape reference (optional)",
        "标签尺寸": "Label Size",
        "我需要自定义特定尺寸 (否则默认使用红绣常规尺寸)": "I need custom specific size (otherwise default Hongxiu standard size)",
        ...
        "粘贴图示 (选填)": "Application Diagram (Optional)",
        ...
        "参考图样或工艺单 (选填)": "Reference Images or Tech Pack (Optional)",
        ...
        "打样开发 (Sampling)": "Sampling Development",
        "大货下单 (Bulk)": "Bulk Order",
        ...
        "中国大陆": "Mainland China",
        "中国 (Mainland China)": "China (Mainland)",
        "其他地区": "Other Region",
        "首选样品快递": "Preferred Sample Courier",
        "使用客户账号 (到付)": "Use Customer Account (Collect)",
        "顺丰速运 (仅限国内)": "SF Express (Domestic Only)",
        "费用说明：": "Fee Notice:",
        ...
        "海运 (经济型)": "Sea Freight (Economy)",
        "空运 (时效型)": "Air Freight (Time-sensitive)",
        ...
        // ── Fee Standard Modal ──
        "红绣服饰 (Hongxiu) 泳装打样收费标准": "Hongxiu Swimwear Sampling Fee Standard",
        ...
        "样衣制作费 (按件收取)": "Sample Making Fee (per piece)",
        "初版样 (Proto)：": "Proto Sample:",
        "修改样 / 产前样 (Fit / PP)：": "Fit / PP Sample:",
        "精细缝制并使用大货正确面料": "Fine sewing using correct bulk fabric",
        "高级工艺附加费 (如涉及需另算)": "Advanced Craft Surcharge (if applicable)",
        ...
        "制版费内含 1 次 基于初样的免费版型微调。自第 2 次修改起，每次收取 $10 调版费。(重大设计变更需视为新款重新制版)。": "Pattern fee includes 1 free adjustment based on proto. From 2nd modification, $10/time. (Major changes treated as new pattern).",
        ...
        "独立包装 (Individual)": "Individual Packaging",
        "环保混装 (Bulk)": "Eco Bulk Packing",
        "外箱装箱规则": "Outer Carton Packing Rules",
        "独色独码 (Solid)": "One Color One Size (Solid)",
        "混色混码 (Assorted)": "Mixed Colors Mixed Sizes (Assorted)",
        "装箱与唛头细节描述": "Packing & Shipping Mark Details",
        "包装参考/贴标样照": "Packaging Reference / Labeling Sample Photo",
        "上传参考文件": "Upload Reference Files",

        // ── MOQ Modal ──
        "红绣服饰 (Hongxiu) 大货起订量标准": "Hongxiu Bulk MOQ Standard",
        "核心原则：": "Core Principle:",
        ...
        "任何款式 (ODM/OEM) + 特殊物料": "Any Style (ODM/OEM) + Special Materials",
        ...
        "品牌官网 / SNS (选填)": "Brand Website / SNS (Optional)",
        ...
        "如: Sarah Chen (选填)": "e.g., Sarah Chen (Optional)",
        "期望指定的打版师": "Preferred Pattern Maker",
        "如: 王师傅 (选填)": "e.g., Master Wang (Optional)",
        "期望指定的样衣组": "Preferred Sample Team",
        "如: A组 (选填)": "e.g., Team A (Optional)",
        "最终补充与条款确认": "Final Remarks & Confirmation",
        "最终补充要求 (Final Notes)": "Final Notes",
        ...
        "综合参考附件 (Comprehensive Tech Pack)": "Comprehensive Tech Pack",
        ...
        "红绣品质标准 (QA Standards)": "Hongxiu QA Standards",
        "红绣品质标准": "Hongxiu QA Standards",
        "针检合格 (Needle Detection Pass)": "Needle Detection Pass",
        "针检合格": "Needle Detection Pass",
        "色牢度 4 级以上 (Color Fastness 4+)": "Color Fastness Grade 4+",
        "色牢度 4 级以上": "Color Fastness Grade 4+",
        "OEKO-TEX 环保染色 (Eco-Dyeing)": "OEKO-TEX Eco-Dyeing",
        "四针六线专业拼缝 (Flatlock Stitch)": "Professional Flatlock Stitch",
        ...
        // ── NDA Modal ──
        "商业保密协议 (Non-Disclosure Agreement)": "Non-Disclosure Agreement (NDA)",
        "商业保密协议": "Non-Disclosure Agreement",
        "甲方 (披露方 / Disclosing Party)": "Party A (Disclosing Party)",
        "乙方 (接收方 / Receiving Party)": "Party B (Receiving Party)",
        ...
        "美国 (USA - FTC 要求)": "USA (FTC Requirements)",
        ...
        "至少一种推荐的洗涤和保养说明（文字或符合ASTM标准的图标）。": "At least one recommended laundering and care instruction (text or ASTM icons).",
        "欧盟": "European Union",
        "英国": "United Kingdom",
    ...
    // ── JS dynamic strings (from custom.js) ──
    var jsDynamic = {
        ...
        "上装/连体": "Top/One-piece",
        "下装/裤装": "Bottom/Pants",
        "领后中 (Center Back Neck)": "Center Back Neck",
        "后腰内中 (Center Back Waist)": "Center Back Waist",
        ...
        "自定义尺寸": "Custom size",
        "已开启 (待选择材质)": "Enabled (material pending)",
        "无印": "No print",
        "未命名品牌": "Unnamed brand",
        ...
        "选择矢量文件 (AI/PDF)": "Select vector file (AI/PDF)",
        ...
        "样衣制作工时费 (总计)": "Sample making labor (total)",
        "现有款式(ODM)": "Existing style (ODM)",
        "自主设计(OEM)": "Custom design (OEM)",
        "初版样 (Proto)": "Proto Sample",
        "修改/试穿样 (Fit)": "Fit Sample",
        "正确/产前样 (PP)": "PP Sample",
        "-- 请选择款式 --": "-- Select style --",
        "打样阶段": "Sampling stage",
        "待定国": "Country pending",
        ...
        "Sea Freight (海运快船)": "Sea Freight (Express)",
        "DHL/FedEx (红绣代办)": "DHL/FedEx (by Hongxiu)",
        ...
        "✓ 已传稿": "✓ Uploaded",
        "× 待传稿": "× Pending",
        "无感印标建议设计为 单色 (黑色或白色)。如需彩色渐变或多色套印，开版费及单价较高。": "Heat transfer labels recommended in single color (black or white). Multi-color designs cost more.",
    ...
    function translateDOM(root) {
        ...
        while (node = walker.nextNode()) {
            ...
            // Try exact match (with whitespace preserved)
            if (dict[trimmed]) {
