...
(function () {
    ...
    var jsDynamic = {
        ...
        "已包含尺寸信息，包括关键部位测量机公差": "Included size information, including key measurement points and tolerances",
        ...
        "我已明确指出上传的设计包含的款式数量及――做出了标识": "I have clearly indicated the number of styles in the uploaded design package and labeled each one",
        "我已明确指出上传的设计包含的款式数量及--做出了标识": "I have clearly indicated the number of styles in the uploaded design package and labeled each one",
        "我已明确指出上传的设计包含的款式数量并逐一做出了标识": "I have clearly indicated the number of styles in the uploaded design package and labeled each one",
